                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-success text-xxs font-weight-bolder opacity-7 ps-2">ID</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-x font-weight-bold mb-0">ID</p>
                      </td>
                      <td>
                        <p class="text-x font-weight-bold mb-0">Email</p>
                      </td>
                      <td>
                        <p class="text-x font-weight-bold mb-0">Nominal</p>
                      </td>
                      <td>
                        <p class="text-x font-weight-bold mb-0">Tanggal</p>
                      </td>
