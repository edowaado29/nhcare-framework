        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="{{ asset('/storage/users/' .$usr->img_user)}}" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1" role="tablist">
                <li class="nav-item">
                  <a href="#" class="nav-link mb-0 px-0 py-1 active d-flex align-items-center justify-content-center " id="triggerFileInput">
                    <i class="ni ni-settings-gear-65"></i>
                    <span class="ms-2">Ubah Foto Profil</span>
                  </a>
                </li>
                <form action="{{ route('uploadImg') }}" method="post" enctype="multipart/form-data" id="fileUploadForm">
                  @csrf
                  @method('PUT')
                  <input type="file" id="img_user" name="img_user" class="d-none">
                </form>
              </ul>
            </div>
          </div>
      ...
      <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="email" value="{{ old('email', $usr->email) }}" readonly>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="example-text-input" class="form-control-label">Nomor Handphone</label>
                      <input class="form-control" type="regex" name="nomor_handphone" value="{{ old('nomor_handphone', $usr->nomor_handphone) }}" onkeypress="return hanyaAngka(event)" oninput="cekPanjangInput(this)">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="example-text-input" class="form-control-label">Tempat Lahir</label>
                      <input class="form-control" type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $usr->tempat_lahir) }}">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="example-text-input" class="form-control-label">Tanggal Lahir</label>
                      <input class="form-control" type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $usr->tanggal_lahir) }}">
                    </div>
                  </div>
                </div>
        ...
        <div class="col-md-3">
          <div class="card card-profile">
            ...
            <a class="nav-link mb-0 px-0 pt-3 active d-flex align-items-center mx-4" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal">
              <i class="ni ni-settings-gear-65"></i>
              <span class="ms-2">Ubah Password</span>
            </a>
            <hr class="horizontal dark">
            <a onclick="confirmLogout(event)" class="nav-link mb-0 px-0 pb-3 active d-flex align-items-center mx-4" style="cursor: pointer;">
              <i class="ni ni-settings-gear-65"></i>
