          ...
          <div class="container mt-3">
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12">
                <a href="{{ route('tambah_donatur') }}" class="btn btn-sm bg-gradient-primary">Tambah Data</a>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12">
              ...
              <table class="table align-items-center mb-0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {{ $dntr->nomor_handphone }}
                    </td>
                    <td class="align-middle text-sm">
                      <form action="{{ route('hapus_donatur', $dntr->id) }}" method="POST" id="delete-form">
                  ...
                  @empty
                  <tr>
                    <td colspan="3" class="text-center">Data Donatur belum Tersedia.</td>
                  </tr>
                  @endforelse
                </tbody>
              </table>
