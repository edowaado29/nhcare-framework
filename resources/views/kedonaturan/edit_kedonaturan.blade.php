            ...
            <div class="card" style="height: 100%">
              <div class="card-body px-0 pt-0 pb-2 mt-3">
                ...
                <div class="form-group">
                    <label for="profile_img" class="text-secondary fs-6">Foto Profil <span class="text-danger">*</span></label><br>
                    <input type="file" class="form-control" id="profile_img" onchange="previewImage(event)">
                </div>
                <div class="row mt-4">
                  <div class="col-6">
