  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Edit Kedonaturan</h6>
      </nav>
                ...
                <div class="container">
                  <form action="{{route ('update_donatur', $donatur->id_donatur )}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="nomor_handphone" name="nomor_handphone" value="{{ old('nomor_handphone', $donatur->nomor_handphone)}}" onkeypress="return hanyaAngka(event)" oninput="cekPanjangInput(this)">
                    </div>
                    <div class="mb-3">
                      <label for="alamat" class="form-label text-secondary fs-6">Alamat</label>
                      <textarea class="form-control" id="alamat" name="alamat" rows="3">{{ old('alamat', $donatur->alamat)}}</textarea>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email', $donatur->email)}}">
                      @error('email')
                      <script>
            ...
            <div class="card">
              <div class="card-body px-0 pt-0 pb-2 mt-3">
                <div class="container">
                  <div class="mb-3">
                    <div class="preview">
                      <label class="text-secondary fs-6">Pratinjau Foto Profil</label><br>
                      <img src="{{ $donatur->foto_donatur !== null ? asset('/storage/kedonaturans/' . $donatur->foto_donatur) : asset('/assets/img/no_image.png') }}" class="mb-3" id="imagePreview" style="width: 100%; height: 400px; border: 2px solid #d4d4d4; border-radius: 10px;">
                    </div>
                  </div>
                </div>
              </div>
