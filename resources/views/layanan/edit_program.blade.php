            ...
            <div class="card-body">
              <form action="{{ route('update', $prog->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="program_name" name="namaProgram" value="{{ old('namaProgram', $prog->namaProgram) }}">
                </div>
                <div class="mb-3">
                  <label for="program_desc" class="form-label text-secondary fs-6">Deskripsi Program <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" id="program_desc" name="deskripsiProgram" value="{{ old('deskripsiProgram', $prog->deskripsiProgram) }}">
                </div>
