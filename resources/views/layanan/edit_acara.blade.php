  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder text-white mb-0">Edit Acara</h6>
      </nav>
          ...
          <div class="col-lg-7 col-md-7 col-sm-12 mt-3">
            <div class="card" style="height: 100%">
              <div class="card-body px-0 pt-0 pb-2 mt-3">
                <div class="container">
                  <form action="{{ route('updateAcr', $acra->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                      <label for="acara_name" class="form-label text-secondary fs-6">Nama Acara <span class="text-danger">*</span></label>
                      <input type="text" class="form-control @error('namaAcara') is-invalid @enderror" id="acara_name" name="namaAcara" value="{{ old('namaAcara', $acra->namaAcara) }}">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="datetime-local" class="form-control @error('tanggalAcara') is-invalid @enderror" id="acara_tanggal" name="tanggalAcara" value="{{ old('tanggalAcara', $acra->tanggalAcara) }}">
                ...
                <div class="container">
                  <div class="mb-3">
                    <div class="preview">
                      ...
                      <img src="{{ asset('/storage/acaras/' .$acra->gambarAcara)}}" class="mb-3" id="imagePreview" style="width: 100%; height: 270px; border: 2px solid #d4d4d4; border-radius: 10px;">
                    </div>
                  </div>
                </div>
              </div>
