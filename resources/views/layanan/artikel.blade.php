            ...
            <div class="container mt-3">
              <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                  <a href="/tambah_artikel" class="btn btn-sm bg-gradient-primary">Tambah Data</a>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <p class="text-x font-weight-bold mb-0">Nama Artikel</p>
                      </td>
                      <td class="align-middle text-sm">
                        <a href="/detail_artikel" class="btn btn-sm bg-gradient-primary">Detail</a>
                        <a href="/edit_artikel" class="btn btn-sm bg-gradient-success">Edit</a>
